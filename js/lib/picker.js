    ...
    Picker.prototype = {
        ...
        _renderPop: function () {
            ...
            if (cols && !qs('#cover') && !qs('#picker')) {
                ...
                this.picker.innerHTML = '<div class="picker-header"><span class="cancel">취소</span><span class="confirm">확인</span></div><div class="picker-items">' + cols + '<div class="picker-line picker-line-top"></div><div class="picker-line picker-line-bottom"></div></div>';
        ...
        _listener: function (el, index, offsetNum) {
            ...
            function touchendtHandler (e) {
                ...
                // 관성
                var nowTime = Date.now();
                var v = (toucheEndY - lastMoveStart) / (nowTime - lastMoveTime); // 슬라이딩 평균 속도
        ...
        setItem: function (config) {
            if (typeof (config) !== 'object') {
                console.error('setItem 파라미터가 잘못되었습니다.');
                return;
            }
